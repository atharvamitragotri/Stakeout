...
import StakeToken from './contracts/Stakecoin.json'
...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    if (stakeTokenData) {
      const stakeToken = new web3.eth.Contract(StakeToken.abi, stakeTokenData.address)
      ...
      window.alert('StakeToken contract not deployed to detected network.')
    }
